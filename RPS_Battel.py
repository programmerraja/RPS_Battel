...
class RPS_Battel():
        ...
        def __init__(s,my_key,my_name,p_key,p_name,app,link,old_root):
             ...
             s.my1=t.Label( s.frame1,text=s.my_name.upper(),font=("arieal",15,"italic"),bg="#01314A",fg="yellow")
             s. my1.place(x=40,y=40)
             s.score1=t.Label( s.frame1,text=str(s.my),font=("arieal",15,"italic"),bg="#01314A",fg="yellow")
             s.score1.place(x=60,y=90)

            
             #opponet name and score
             s.robo=t.Label( s.frame1,text=s.p_name.upper(),font=("arieal",15,"italic"),bg="#FA1C23",fg="yellow")
             s.robo.place(x=450,y=40)
             
             s.score2=t.Label( s.frame1,text=str(s.player),font=("arieal",15,"italic"),bg="#FA1C23",fg="yellow")
             s.score2.place(x=470,y=90)
             
             s.status=t.Label( s.frame1,text="",font=("arieal",20,"italic"),bg=color,fg="yellow")
             ...
             s.scissor=t.Button( s.frame,height=140,width=140,image=s.scssisor_image,command=lambda:s.check("3"),relief="groove",activebackground=s.b_color)
             s.scissor.place(x=5,y=50)

             s.rock_image=t.PhotoImage(file=join(getcwd(),"image","rock.png"))
             s.rock=t.Button( s.frame,width=140,height=140,image=s.rock_image,command=lambda:s.check("1"),relief="groove",activebackground=s.b_color)
             s.rock.place(x=165,y=50)

             s.paper_image=t.PhotoImage(file=join(getcwd(),"image","paper.png"))
             s.paper=t.Button( s.frame,width=140,height=140,image=s.paper_image,command=lambda:s.check("2"),relief="groove",activebackground=s.b_color)
             s.paper.place(x=325,y=50)

             s.f=t.Frame(height=10,width=20,bg=color).grid()
             s.status["text"]="   CLICK ANY ONE ! "
             s.backbut=t.Button(s.root,text="Back To Lobby",fg="black",bg="green",command=s.back,activebackground="#f95d9b").place(x=150,y=470)
             
             s.exit=t.Button(s.root,text="Exit",font=("arieal",8,"bold"),command=lambda :s.at_exit(1),activebackground="#f95d9b",bg="green",width=10)
...
class Game_lobby:
        ...
        def Create_lobby(s,isback=False):
             ...
             s.score=t.Label( s.root,text="Enter your name:",font=("arieal",10,"bold"),bg=color,fg="yellow")
             s.score.place(x=120,y=120)

             s.reg=t.Button(s.root,text="Register",font=("arieal",10,"bold"),command=s.Register,activebackground="#f95d9b")
             ...
             s.lobby=t.Label( s.root,text="Choose Player ",font=("arieal",20,"italic"),bg=color,fg="yellow")
             ...
             s.exit=t.Button(s.root,text="Exit",font=("arieal",8,"bold"),bg="green",command=lambda :s.at_exit(1),activebackground="#f95d9b",width=10)
        ...
        def Register(s,event=None):
                ...
                try:
                        ...
                        s.app=firebase.FirebaseApplication("https://pydatabase.firebaseio.com/",None)
                        s.my_name=s.entry.get()
                        if(s.my_name):
                                data={"name":s.my_name,"is_playing":"0","p_move":"0","p_key":"","inv":"0","p_name":""}
                                         ...
                                         for i in s.old_data.keys():
                                            ...
                                            if(i!=s.my_key):
                                             ...
                                             if(s.old_data[i]["is_playing"]=="0"): 
                                                     ...
                                                     s.b.append(t.Button(s.frame,text=s.old_data[i]["name"],activebackground="#f95d9b"))
                                                     s.b[k].place(x=x,y=y)
